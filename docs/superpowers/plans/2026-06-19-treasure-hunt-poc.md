...
const FIXTURE = {
  elements: [
    { type: "node", id: 1, tags: { name: "No Tags Park" } },
    { type: "node", id: 2, tags: {} }, // unnamed -> excluded
    { type: "way",  id: 3, tags: { name: "Old Clock Tower", historic: "tower", "addr:street": "Market St" } },
    { type: "node", id: 4, tags: { name: "Tourist Pier", tourism: "attraction", wikidata: "Q123" } },
  ],
};
